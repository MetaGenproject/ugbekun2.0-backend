...
export interface EvaluationMatrixParams {
  studentId: number;
  classId: number;
  sectionId: number;
  branchId: number;
 ...
 */
export async function bindEvaluationMatrix(tx: any, { studentId, classId, sectionId, branchId, sessionId }: EvaluationMatrixParams) {
 ...
 */
export async function wipeEvaluationMatrix(tx: any, { studentId, sessionId }: { studentId: number; sessionId: number }) {
